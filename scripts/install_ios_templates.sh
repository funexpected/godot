...
scons p=iphone tools=no bits=64 target=release arch=arm64 module_firebase_enabled=no module_websocket_enabled=no
scons p=iphone tools=no bits=32 target=release arch=armv7 module_firebase_enabled=no module_websocket_enabled=no
lipo -create bin/libgodot.iphone.opt.arm.a bin/libgodot.iphone.opt.arm64.a -output bin/libgodot.iphone.release.fat.a
scons p=iphone tools=no bits=64 target=debug arch=arm64 module_firebase_enabled=no module_websocket_enabled=no
scons p=iphone tools=no bits=32 target=debug arch=armv7 module_firebase_enabled=no module_websocket_enabled=no
