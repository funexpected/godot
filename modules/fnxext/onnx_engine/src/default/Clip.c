...
void resolver_default_op_Clip(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Clip_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Clip_init;
			n->exit = Clip_exit;
			n->reshape = Clip_reshape;
			n->operator_ = Clip_float64;
			break;
		default:
			break;
		}
