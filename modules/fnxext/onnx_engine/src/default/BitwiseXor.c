...
void resolver_default_op_BitwiseXor(struct onnx_node_t * n)
{
	if(n->opset >= 18)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = BitwiseXor_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = BitwiseXor_init;
			n->exit = BitwiseXor_exit;
			n->reshape = BitwiseXor_reshape;
			n->operator_ = BitwiseXor_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = BitwiseXor_init;
			n->exit = BitwiseXor_exit;
			n->reshape = BitwiseXor_reshape;
			n->operator_ = BitwiseXor_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = BitwiseXor_init;
			n->exit = BitwiseXor_exit;
			n->reshape = BitwiseXor_reshape;
			n->operator_ = BitwiseXor_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = BitwiseXor_init;
			n->exit = BitwiseXor_exit;
			n->reshape = BitwiseXor_reshape;
			n->operator_ = BitwiseXor_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = BitwiseXor_init;
			n->exit = BitwiseXor_exit;
			n->reshape = BitwiseXor_reshape;
			n->operator_ = BitwiseXor_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = BitwiseXor_init;
			n->exit = BitwiseXor_exit;
			n->reshape = BitwiseXor_reshape;
			n->operator_ = BitwiseXor_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = BitwiseXor_init;
			n->exit = BitwiseXor_exit;
			n->reshape = BitwiseXor_reshape;
			n->operator_ = BitwiseXor_uint64;
			break;
		default:
			break;
		}
