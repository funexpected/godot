...
void resolver_default_op_Abs(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Abs_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Abs_init;
			n->exit = Abs_exit;
			n->reshape = Abs_reshape;
			n->operator_ = Abs_float64;
			break;
		default:
			break;
		}
