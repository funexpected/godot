...
void resolver_default_op_ReduceL1(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = ReduceL1_int8;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = ReduceL1_init;
			n->exit = ReduceL1_exit;
			n->reshape = ReduceL1_reshape;
			n->operator_ = ReduceL1_float64;
			break;
		default:
			break;
		}
