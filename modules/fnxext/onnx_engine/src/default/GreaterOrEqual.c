...
void resolver_default_op_GreaterOrEqual(struct onnx_node_t * n)
{
	if(n->opset >= 12)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = GreaterOrEqual_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_uint64;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = GreaterOrEqual_init;
			n->exit = GreaterOrEqual_exit;
			n->reshape = GreaterOrEqual_reshape;
			n->operator_ = GreaterOrEqual_float64;
			break;
		default:
			break;
		}
