...
void resolver_default_op_ArgMax(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = ArgMax_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = ArgMax_init;
			n->exit = ArgMax_exit;
			n->reshape = ArgMax_reshape;
			n->operator_ = ArgMax_float64;
			break;
		default:
			break;
		}
