...
void resolver_default_op_ReduceL2(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = ReduceL2_int8;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = ReduceL2_init;
			n->exit = ReduceL2_exit;
			n->reshape = ReduceL2_reshape;
			n->operator_ = ReduceL2_float64;
			break;
		default:
			break;
		}
