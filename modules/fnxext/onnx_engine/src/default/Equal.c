...
void resolver_default_op_Equal(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_BOOL:
			...
			n->operator_ = Equal_bool;
			break;
		case ONNX_TENSOR_TYPE_INT8:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Equal_init;
			n->exit = Equal_exit;
			n->reshape = Equal_reshape;
			n->operator_ = Equal_float64;
			break;
		default:
			break;
		}
