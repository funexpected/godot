...
void resolver_default_op_Max(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Max_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Max_init;
			n->exit = Max_exit;
			n->reshape = Max_reshape;
			n->operator_ = Max_float64;
			break;
		default:
			break;
		}
