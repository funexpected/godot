...
void resolver_default_op_Greater(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Greater_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Greater_init;
			n->exit = Greater_exit;
			n->reshape = Greater_reshape;
			n->operator_ = Greater_float64;
			break;
		default:
			break;
		}
