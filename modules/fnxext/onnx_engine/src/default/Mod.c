...
void resolver_default_op_Mod(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Mod_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Mod_init;
			n->exit = Mod_exit;
			n->reshape = Mod_reshape;
			n->operator_ = Mod_float64;
			break;
		default:
			break;
		}
