...
void resolver_default_op_Shrink(struct onnx_node_t * n)
{
	if(n->opset >= 9)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Shrink_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_uint64;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Shrink_init;
			n->exit = Shrink_exit;
			n->reshape = Shrink_reshape;
			n->operator_ = Shrink_float64;
			break;
		default:
			break;
		}
