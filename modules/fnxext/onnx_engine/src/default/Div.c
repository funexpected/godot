...
void resolver_default_op_Div(struct onnx_node_t * n)
{
	...
	switch(n->inputs[0]->type)
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Div_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_13_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Div_init;
			n->exit = Div_exit;
			n->reshape = Div_reshape;
			n->operator_ = Div_float64;
			break;
		default:
			break;
		}
