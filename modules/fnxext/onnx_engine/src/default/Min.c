...
void resolver_default_op_Min(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Min_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Min_init;
			n->exit = Min_exit;
			n->reshape = Min_reshape;
			n->operator_ = Min_float64;
			break;
		default:
			break;
		}
