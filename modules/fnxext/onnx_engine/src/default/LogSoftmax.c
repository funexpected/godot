...
void resolver_default_op_LogSoftmax(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_BFLOAT16:
			...
			n->operator_ = LogSoftmax_13_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = LogSoftmax_13_init;
			n->exit = LogSoftmax_13_exit;
			n->reshape = LogSoftmax_13_reshape;
			n->operator_ = LogSoftmax_13_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = LogSoftmax_13_init;
			n->exit = LogSoftmax_13_exit;
			n->reshape = LogSoftmax_13_reshape;
			n->operator_ = LogSoftmax_13_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = LogSoftmax_13_init;
			n->exit = LogSoftmax_13_exit;
			n->reshape = LogSoftmax_13_reshape;
			n->operator_ = LogSoftmax_13_float64;
			break;
		default:
			break;
		}
	...
	else if(n->opset >= 11)
	{
		...
		case ONNX_TENSOR_TYPE_FLOAT16:
			...
			n->operator_ = LogSoftmax_1_11_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = LogSoftmax_1_11_init;
			n->exit = LogSoftmax_1_11_exit;
			n->reshape = LogSoftmax_1_11_reshape;
			n->operator_ = LogSoftmax_1_11_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = LogSoftmax_1_11_init;
			n->exit = LogSoftmax_1_11_exit;
			n->reshape = LogSoftmax_1_11_reshape;
			n->operator_ = LogSoftmax_1_11_float64;
			break;
		default:
			break;
		}
