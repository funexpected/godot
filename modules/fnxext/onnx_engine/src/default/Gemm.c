...
void resolver_default_op_Gemm(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT32:
			...
			n->operator_ = Gemm_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Gemm_init;
			n->exit = Gemm_exit;
			n->reshape = Gemm_reshape;
			n->operator_ = Gemm_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Gemm_init;
			n->exit = Gemm_exit;
			n->reshape = Gemm_reshape;
			n->operator_ = Gemm_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Gemm_init;
			n->exit = Gemm_exit;
			n->reshape = Gemm_reshape;
			n->operator_ = Gemm_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Gemm_init;
			n->exit = Gemm_exit;
			n->reshape = Gemm_reshape;
			n->operator_ = Gemm_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Gemm_init;
			n->exit = Gemm_exit;
			n->reshape = Gemm_reshape;
			n->operator_ = Gemm_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Gemm_init;
			n->exit = Gemm_exit;
			n->reshape = Gemm_reshape;
			n->operator_ = Gemm_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Gemm_init;
			n->exit = Gemm_exit;
			n->reshape = Gemm_reshape;
			n->operator_ = Gemm_float64;
			break;
		default:
			break;
		}
