...
void resolver_default_op_PRelu(struct onnx_node_t * n)
{
	if(n->opset >= 9)
	{
		...
		case ONNX_TENSOR_TYPE_INT32:
			...
			n->operator_ = PRelu_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = PRelu_init;
			n->exit = PRelu_exit;
			n->reshape = PRelu_reshape;
			n->operator_ = PRelu_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = PRelu_init;
			n->exit = PRelu_exit;
			n->reshape = PRelu_reshape;
			n->operator_ = PRelu_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = PRelu_init;
			n->exit = PRelu_exit;
			n->reshape = PRelu_reshape;
			n->operator_ = PRelu_uint64;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = PRelu_init;
			n->exit = PRelu_exit;
			n->reshape = PRelu_reshape;
			n->operator_ = PRelu_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = PRelu_init;
			n->exit = PRelu_exit;
			n->reshape = PRelu_reshape;
			n->operator_ = PRelu_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = PRelu_init;
			n->exit = PRelu_exit;
			n->reshape = PRelu_reshape;
			n->operator_ = PRelu_float64;
			break;
		default:
			break;
		}
