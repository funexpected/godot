...
static int ReduceSum_reshape(struct onnx_node_t * n)
{
	...
	if((n->ninput > 1) && (n->inputs[1]->ndata > 0))
	{
		...
		pdat->naxes = minn(minn(x->ndim, 32), (int)a->ndata);
...
void resolver_default_op_ReduceSum(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = ReduceSum_int8;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = ReduceSum_init;
			n->exit = ReduceSum_exit;
			n->reshape = ReduceSum_reshape;
			n->operator_ = ReduceSum_float64;
			break;
		default:
			break;
		}
