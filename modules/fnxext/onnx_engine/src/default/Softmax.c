...
void resolver_default_op_Softmax(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_BFLOAT16:
			...
			n->operator_ = Softmax_13_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Softmax_13_init;
			n->exit = Softmax_13_exit;
			n->reshape = Softmax_13_reshape;
			n->operator_ = Softmax_13_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Softmax_13_init;
			n->exit = Softmax_13_exit;
			n->reshape = Softmax_13_reshape;
			n->operator_ = Softmax_13_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Softmax_13_init;
			n->exit = Softmax_13_exit;
			n->reshape = Softmax_13_reshape;
			n->operator_ = Softmax_13_float64;
			break;
		default:
			break;
		}
	...
	else if(n->opset >= 11)
	{
		...
		case ONNX_TENSOR_TYPE_FLOAT16:
			...
			n->operator_ = Softmax_1_11_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Softmax_1_11_init;
			n->exit = Softmax_1_11_exit;
			n->reshape = Softmax_1_11_reshape;
			n->operator_ = Softmax_1_11_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Softmax_1_11_init;
			n->exit = Softmax_1_11_exit;
			n->reshape = Softmax_1_11_reshape;
			n->operator_ = Softmax_1_11_float64;
			break;
		default:
			break;
		}
