...
void resolver_default_op_Neg(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Neg_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Neg_init;
			n->exit = Neg_exit;
			n->reshape = Neg_reshape;
			n->operator_ = Neg_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Neg_init;
			n->exit = Neg_exit;
			n->reshape = Neg_reshape;
			n->operator_ = Neg_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Neg_init;
			n->exit = Neg_exit;
			n->reshape = Neg_reshape;
			n->operator_ = Neg_int64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Neg_init;
			n->exit = Neg_exit;
			n->reshape = Neg_reshape;
			n->operator_ = Neg_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Neg_init;
			n->exit = Neg_exit;
			n->reshape = Neg_reshape;
			n->operator_ = Neg_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Neg_init;
			n->exit = Neg_exit;
			n->reshape = Neg_reshape;
			n->operator_ = Neg_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Neg_init;
			n->exit = Neg_exit;
			n->reshape = Neg_reshape;
			n->operator_ = Neg_float64;
			break;
		default:
			break;
		}
