...
void resolver_default_op_Sign(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Sign_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Sign_init;
			n->exit = Sign_exit;
			n->reshape = Sign_reshape;
			n->operator_ = Sign_float64;
			break;
		default:
			break;
		}
