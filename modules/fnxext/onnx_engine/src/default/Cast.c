...
void resolver_default_op_Cast(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_BOOL:
			...
			n->operator_ = Cast_bool;
			break;
		case ONNX_TENSOR_TYPE_INT8:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_float64;
			break;
		case ONNX_TENSOR_TYPE_STRING:
			n->init = Cast_init;
			n->exit = Cast_exit;
			n->reshape = Cast_reshape;
			n->operator_ = Cast_string;
			break;
		default:
			break;
		}
