...
void resolver_default_op_BitwiseNot(struct onnx_node_t * n)
{
	if(n->opset >= 18)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = BitwiseNot_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = BitwiseNot_init;
			n->exit = BitwiseNot_exit;
			n->reshape = BitwiseNot_reshape;
			n->operator_ = BitwiseNot_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = BitwiseNot_init;
			n->exit = BitwiseNot_exit;
			n->reshape = BitwiseNot_reshape;
			n->operator_ = BitwiseNot_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = BitwiseNot_init;
			n->exit = BitwiseNot_exit;
			n->reshape = BitwiseNot_reshape;
			n->operator_ = BitwiseNot_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = BitwiseNot_init;
			n->exit = BitwiseNot_exit;
			n->reshape = BitwiseNot_reshape;
			n->operator_ = BitwiseNot_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = BitwiseNot_init;
			n->exit = BitwiseNot_exit;
			n->reshape = BitwiseNot_reshape;
			n->operator_ = BitwiseNot_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = BitwiseNot_init;
			n->exit = BitwiseNot_exit;
			n->reshape = BitwiseNot_reshape;
			n->operator_ = BitwiseNot_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = BitwiseNot_init;
			n->exit = BitwiseNot_exit;
			n->reshape = BitwiseNot_reshape;
			n->operator_ = BitwiseNot_uint64;
			break;
		default:
			break;
		}
