...
void resolver_default_op_Sub(struct onnx_node_t * n)
{
	if(n->opset >= 14)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Sub_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Sub_init;
			n->exit = Sub_exit;
			n->reshape = Sub_reshape;
			n->operator_ = Sub_float64;
			break;
		default:
			break;
		}
