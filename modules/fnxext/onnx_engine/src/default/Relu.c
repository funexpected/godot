...
void resolver_default_op_Relu(struct onnx_node_t * n)
{
	if(n->opset >= 14)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = Relu_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Relu_init;
			n->exit = Relu_exit;
			n->reshape = Relu_reshape;
			n->operator_ = Relu_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Relu_init;
			n->exit = Relu_exit;
			n->reshape = Relu_reshape;
			n->operator_ = Relu_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Relu_init;
			n->exit = Relu_exit;
			n->reshape = Relu_reshape;
			n->operator_ = Relu_int64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Relu_init;
			n->exit = Relu_exit;
			n->reshape = Relu_reshape;
			n->operator_ = Relu_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Relu_init;
			n->exit = Relu_exit;
			n->reshape = Relu_reshape;
			n->operator_ = Relu_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Relu_init;
			n->exit = Relu_exit;
			n->reshape = Relu_reshape;
			n->operator_ = Relu_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Relu_init;
			n->exit = Relu_exit;
			n->reshape = Relu_reshape;
			n->operator_ = Relu_float64;
			break;
		default:
			break;
		}
