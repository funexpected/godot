...
void resolver_default_op_ArgMin(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_INT8:
			...
			n->operator_ = ArgMin_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = ArgMin_init;
			n->exit = ArgMin_exit;
			n->reshape = ArgMin_reshape;
			n->operator_ = ArgMin_float64;
			break;
		default:
			break;
		}
